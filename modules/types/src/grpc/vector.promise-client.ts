 ...
 * @generated from protobuf service com.vector.VectorService
 */
export class VectorServiceClient implements IVectorServiceClient, ServiceInfo {
    typeName = VectorService.typeName;
    methods = VectorService.methods;
    options = VectorService.options;
