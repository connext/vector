# Migration `20201109200837-chainid-string-tx`

This migration has been generated by LayneHaber at 11/9/2020, 1:08:37 PM.
...
CREATE UNIQUE INDEX "onchain_transaction.from_nonce_chainId_unique" ON "public"."onchain_transaction"("from", "nonce", "chainId")
...
migration 20201109190051-chainid-string..20201109200837-chainid-string-tx
--- datamodel.dml
+++ datamodel.dml
@@ -5,9 +5,9 @@
 }
