# Migration `20201109204504-transaction-unique-constraints`

This migration has been generated by LayneHaber at 11/9/2020, 1:45:04 PM.
...
CREATE UNIQUE INDEX "onchain_transaction.transactionHash_chainId_unique" ON "public"."onchain_transaction"("transactionHash", "chainId")
...
migration 20201109200837-chainid-string-tx..20201109204504-transaction-unique-constraints
--- datamodel.dml
+++ datamodel.dml
@@ -5,9 +5,9 @@
 }
