describe("Channel Setup", () => {
  ...
  it("Setting up channel", function() {
    ...
    // }
    cy.get('#deposit > .ant-row > .ant-col-18 > .ant-form-item-control-input > .ant-form-item-control-input-content > .ant-input-group-wrapper > .ant-input-wrapper > .ant-input')
    .type(this.response.body[0].publicIdentifier)
    cy.get(':nth-child(5) > .ant-col-24 > #deposit > .ant-row > .ant-col-18 > .ant-form-item-control-input > .ant-form-item-control-input-content > .ant-input-group-wrapper > .ant-input-wrapper > .ant-input-group-addon > .ant-btn')
    .click().pause();
